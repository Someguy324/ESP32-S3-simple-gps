...
#define TEST_DEVICE_NAME            "ESP_GPS"
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        rsp.attr_value.value[1] = 'a';
        rsp.attr_value.value[2] = 't';
        rsp.attr_value.value[3] = ':';
        rsp.attr_value.value[4] = gps_data.lat[0];
        rsp.attr_value.value[5] = gps_data.lat[1];
        rsp.attr_value.value[6] = gps_data.lat[2];
        rsp.attr_value.value[7] = gps_data.lat[3];
        rsp.attr_value.value[8] = gps_data.lat[4];
        rsp.attr_value.value[9] = gps_data.lat[5];        
...
static void gatts_profile_b_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        rsp.attr_value.value[0] = gps_data.lat[0];
        rsp.attr_value.value[1] = gps_data.lat[1];
        rsp.attr_value.value[2] = gps_data.lat[2];
        rsp.attr_value.value[3] = gps_data.lat[3];
        rsp.attr_value.value[4] = gps_data.lat[4];
        rsp.attr_value.value[5] = gps_data.lat[5];
        rsp.attr_value.value[6] = gps_data.lat[6];
        rsp.attr_value.value[7] = gps_data.lat[7];
        rsp.attr_value.value[8] = gps_data.lat[8];
        rsp.attr_value.value[9] = gps_data.lat[9];
        rsp.attr_value.value[10] = gps_data.lat[10];
        rsp.attr_value.value[11] = gps_data.lat[11];
        rsp.attr_value.value[12] = gps_data.lat[12];
        rsp.attr_value.value[13] = gps_data.lat[13];
        rsp.attr_value.value[14] = gps_data.lat[14];
        rsp.attr_value.value[15] = gps_data.lat[15];
        rsp.attr_value.value[16] = ' ';
        rsp.attr_value.value[17] = gps_data.lon[0];
        rsp.attr_value.value[18] = gps_data.lon[1];
        rsp.attr_value.value[19] = gps_data.lon[2];
        rsp.attr_value.value[20] = gps_data.lon[3];
        rsp.attr_value.value[21] = gps_data.lon[4];
        rsp.attr_value.value[22] = gps_data.lon[5];        
